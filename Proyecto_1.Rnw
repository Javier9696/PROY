...
\begin{block}{\small Interpretaci\'on }  
  ...
  \begin{block}{\small {Interpretaci\'on}}
  Tomando un periodo de tiempo de un mes\\
  existe una tendencia alcista entre el inicio\\
  de la gr\'afica y el final del periodo, sin embargo,\\
  El MACD muestra una divergencia negativa,\\
  donde eventualmente la acci\'on tendr\'a un movimiento a la baja.
  \end{block}
  ...
  \begin{block}{\small Ljung-Box test }
  ...
  Ventana  & P-Value \\
  \hline \hline
  0-150 d\'ias & \Sexpr{Box[1]} \\ \hline
  150-300 d\'ias & \Sexpr{Box[2]} \\ \hline
  301-500 d\'ias & \Sexpr{Box[3]} \\ \hline
  500 d\'ias & \Sexpr{Box[4]} \\ \hline
  \end{tabular}
  ...
  \begin{column}{.25 \linewidth}
  \begin{block}{\small Interpretaci\'on }
  La prueba indica autocorreaci\'on en la Serie de tiempo .\\
  Se busca tener un p-value < .05 para aceptar que no existe\\
  autocorrelaci\'on en el primer rezago de la serie. 
  
  
  \end{block}
  \end{column}
  \begin{column}{.25 \linewidth}
  \begin{block}{\small Kolmogorov-Smirnov test }
  \begin{table}[htbp]
  ...
  Ventana  & P-Value \\
  \hline \hline
  0-150 d\'ias & \Sexpr{norm[1]} \\ \hline
  150-300 d\'ias & \Sexpr{norm[2]} \\ \hline
  301-500 d\'ias & \Sexpr{norm[3]} \\ \hline
  500 d\'ias & \Sexpr{norm[4]} \\ \hline
  \end{tabular}
  ...
  \begin{column}{.25 \linewidth}
  \begin{block}{\small Interpretaci\'on }
  La prueba busca el ajuste  una distribuci\'on de probabilidad\\
  en este caso a la distribuci\'on normal.
  Se busca que se acepte la Hi\'potesis nula es decir que se ajusta la distribuci\'on\\
  de probabilidad.
